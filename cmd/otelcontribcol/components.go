...
func components() (otelcol.Factories, error) {
	...
	factories.ExtensionModules[lumigoauthextension.NewFactory().Type()] = "github.com/lumigo-io/lumigo-otel-collector-contrib/extension/lumigoauthextension v0.116.0"
