...
require (
	...
	github.com/lumigo-io/lumigo-otel-collector-contrib/internal/k8sconfig v0.116.0 // indirect
...
replace github.com/lumigo-io/lumigo-otel-collector-contrib/internal/k8sconfig => ./internal/k8sconfig

replace github.com/lumigo-io/lumigo-otel-collector-contrib/extension/lumigoauthextension => ./extension/lumigoauthextension
...
replace go.opentelemetry.io/collector/confmap/provider/envprovider => go.opentelemetry.io/collector/confmap/provider/envprovider v1.18.0

replace go.opentelemetry.io/collector/confmap/provider/fileprovider => go.opentelemetry.io/collector/confmap/provider/fileprovider v1.18.0

replace go.opentelemetry.io/collector/confmap/provider/httpprovider => go.opentelemetry.io/collector/confmap/provider/httpprovider v1.18.0

replace go.opentelemetry.io/collector/confmap/provider/httpsprovider => go.opentelemetry.io/collector/confmap/provider/httpsprovider v1.18.0

replace go.opentelemetry.io/collector/confmap/provider/yamlprovider => go.opentelemetry.io/collector/confmap/provider/yamlprovider v1.18.0
