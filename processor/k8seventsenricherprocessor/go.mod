...
require (
	...
	github.com/lumigo-io/lumigo-otel-collector-contrib/internal/k8sconfig v0.99.0
	...
	golang.org/x/net v0.23.0 // indirect; override
	k8s.io/api v0.29.3
...
replace github.com/lumigo-io/lumigo-otel-collector-contrib/internal/k8sconfig v0.99.0 => ./../../internal/k8sconfig
