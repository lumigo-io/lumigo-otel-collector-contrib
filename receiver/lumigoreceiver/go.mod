module github.com/lumigo-io/lumigo-otel-collector-contrib/receiver/lumigoreceiver
...
require (
	...
	go.opentelemetry.io/collector/confmap v0.116.0
	...
	golang.org/x/net v0.32.0 // indirect; override
)
